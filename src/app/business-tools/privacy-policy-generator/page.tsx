        ...
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 font-headline">
              <FileLock size={28} className="text-primary" />
              Privacy Policy Generator
            </CardTitle>
            <CardDescription>Create a privacy policy document for your online services. This tool is currently under development.</CardDescription>
          </CardHeader>
          <CardContent>
