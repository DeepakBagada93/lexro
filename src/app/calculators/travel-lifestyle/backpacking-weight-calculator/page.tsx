...
export default function BackpackingWeightCalculatorPage() {
  return (
      ...
      <main className="flex-grow container mx-auto px-4 py-10 sm:py-16">
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>Calculate and manage the weight of your backpacking gear. This tool is currently under development.</CardDescription>
          </CardHeader>
          <CardContent>
