...
export default function WebpToJpgConverterPage() {
  ...
  const handleConvert = () => {
    ...
    img.onload = () => {
      ...
      if (ctx) {
        // For WEBP with alpha, it will be drawn on transparent background.
        // JPG doesn't support alpha, so draw white background first.
      ...
      <main className="flex-grow container mx-auto px-4 py-10 sm:py-16">
        <Card className="max-w-2xl mx-auto shadow-xl">
          <CardHeader>
            ...
            <CardDescription>Convert your WEBP images to JPG format. Adjust quality as needed.</CardDescription>
          </CardHeader>
