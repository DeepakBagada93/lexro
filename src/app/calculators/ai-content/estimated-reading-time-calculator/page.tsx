...
export default function EstimatedReadingTimeCalculatorPage() {
  return (
      ...
      <main className="flex-grow container mx-auto px-4 py-10 sm:py-16">
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>Estimate how long it will take to read a piece of text. This tool is currently under development.</CardDescription>
          </CardHeader>
          <CardContent>
