      ...
      if (ctx) {
        ...
        try {
          ...
          toast({ title: "Conversion Successful", description: "Image successfully converted to WEBP." });
            ...
            toast({ title: "Conversion Error", description: "Could not convert image to WEBP. Your browser might not support it.", variant: "destructive" });
            setConvertedImageDataUrl(null);
        }
      } else {
      ...
      <main className="flex-grow container mx-auto px-4 py-10 sm:py-16">
        <Card className="max-w-2xl mx-auto shadow-xl">
          <CardHeader>
            ...
            <CardDescription>Convert JPG images to modern WEBP format for superior compression and quality. Adjust quality as needed.</CardDescription>
          </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
              {originalImageDataUrl && (
                <div className="space-y-2">
                  ...
                  <ImagePreview src={originalImageDataUrl} alt="Original JPG preview" />
                </div>
              )}
