...
export default function AiSuggestionToolPage() {
  return (
      ...
      <main className="flex-grow container mx-auto px-4 py-10 sm:py-16">
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>Get intelligent suggestions for various tasks. This tool is currently under development.</CardDescription>
          </CardHeader>
          <CardContent>
